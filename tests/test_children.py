...
def test_compute_results_match():
    ...
    activations = torch.randint(0, 2, (batch_size, n_features), dtype=torch.bool, device=device)
    perturbation_choices = torch.randint(0, n_children, (batch_size, n_features), device=device)
    ...
    result1 = compute_result(activations, perturbation_choices, features, perturbations, device)
    result2 = compute_result2(activations, perturbation_choices, features, perturbations, device)
